...
// export default function OngoingCheckup({ appointments = [], onSelect }) {
//   const currentUser = useSelector((state) => state.user.userInfo);
//   const [openIndexes, setOpenIndexes] = useState([]); // for staff collapsible view
...
//         <p className="text-sm text-gray-500 italic">No ongoing checkups.</p>
//       ) : (
...
//                   }`}
//                   onClick={() => !isDoctor && toggleCollapse(idx)}
//                 >

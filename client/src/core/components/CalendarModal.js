...
function CalendarModal({ report, onClose }) {
  ...
  const forecastDate = new Date(report.forecastDate);
      ...
      >
        ...
        <div className="space-y-6">
          <div className="flex items-center">
            ...
            <p className="text-gray-600">{report.patientName}</p>
          </div>

          <div className="flex items-center">
            <strong className="text-gray-700 w-1/3">Forecast Date:</strong>
            <p className="text-gray-600">{report.forecastDate}</p>
          </div>
